	...
	public class CreateStairs : MonoBehaviour {
		...
		void CreateShape() {
			...
			for (int i = 0; i < numberOfSteps; i++) {
				...
				// top front:
				int v3 = builder.AddVertex (offset + new Vector3 (width, 1, 0), new Vector2 (1, 0.5f));	
				int v4 = builder.AddVertex (offset + new Vector3 (-width, 1, 0), new Vector2 (0, 0.5f));
				// top back:
				int v5 = builder.AddVertex (offset + new Vector3 (width, 1, 1), new Vector2 (1, 1));	
				int v6 = builder.AddVertex (offset + new Vector3 (-width, 1, 1), new Vector2 (0, 1));
